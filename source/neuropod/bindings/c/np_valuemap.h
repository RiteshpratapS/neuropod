...
// Note: this does not transfer ownership and the caller is still responsible for calling NP_DecrementRefcount on
// `tensor`
...
// Note: the caller is responsible for calling NP_DecrementRefcount on the returned tensor
