...
// Drops the internal refcount of the underlying tensor
// This should be called on any tensor returned by the C API.
// See the notes in `np_valuemap.h` and `np_tensor_allocator.h`
void NP_DecrementRefcount(NP_NeuropodTensor *tensor);
